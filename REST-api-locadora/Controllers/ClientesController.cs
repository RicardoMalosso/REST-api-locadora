...
namespace REST_api_locadora.Controllers
{
    ...
    public class ClientesController : ControllerBase
    {
        ...
        {
            return await _context.Clientes.Where(e => !e.IsDeleted).ToListAsync();
        }
        ...
        {
            var cliente = await _context.Clientes.Where(e => !e.IsDeleted && e.Id == id).FirstOrDefaultAsync();
        ...
        public async Task<ActionResult<Cliente>> PostCliente(Cliente cliente)
        {
            ...
            if (ClienteExistsByName(cliente.Name))
            {
                return BadRequest("Já existe um cliente com esse nome.");
            }
